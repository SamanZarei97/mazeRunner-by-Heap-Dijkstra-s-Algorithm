...
/**
 * This class contains some testing method to check 
 * the correctness of implementation for the MazeSolver class
 * @author saman
 *
 */
public class TestSolvers {
    ...
    /**
     * This method checks the correctness of MazeSolver class when 
     * we have a short path from start to end.
     */
	@Test
	...
	/**
	 * This method checks the correctness of MazeSolver class
	 * when the is no diagonal solution from start to end
	 */
	@Test
	...
	/**
	 * This method checks the correctness of MazeSolver class
	 * when there is a long path from start to end
	 */
	@Test
	public void testMazeSolver_solutionLong() {
		...
		int[][] costArray = new int[][] {{1,1,1,0},
			  							{1,0,0,5},
			  							{1,0,0,5},
			  							{1,1,1,1}};
	
	    Maze m = new Maze(mazeString, costArray);
	    String[] queueExpected = {"***S",
	    		  				  "*##_",
	    		  				  "*##_",
	    		  				  "***F"};
	    checkMaze(new Heap<Integer, Square>(new IntComparator()), m, queueExpected);
	...
	/**
	 * This method checks the correctness of MazeSolver class
	 * when there is a short path from start to end
	 */
	@Test
	...
	/**
	 * This method checks the correctness of MazeSolver class when
	 * there is a straight path from start to end
	 */
	@Test
	public void testMazeSolver_solution1x8() {
		String[] mazeString = new String[]  
				{"F______S"};
	 ...
	 */
	@Test
	public void testMazeSolver_solution4x1() {
		String[] mazeString = new String[]{
				"S", "_", "_", "F" };
		
		int[][] costArray = new int[][] {{0},{1},{1},{1}};

		Maze m = new Maze(mazeString, costArray);
		String[] queueExpected =  {"S","*","*","F"};
	...
	/**
	 * This method checks the correctness of MazeSolver class when
	 * there is a straight path but no way from start to end
	 */
	@Test
	public void testMazeSolver_noSolution4x1() {
		String[] mazeString = new String[]  
				{"S",
				 "#",
				 "_",
	 ...
	 */
	@Test
	public void testMazeSolver_solution10x10() {
		String[] mazeString = new String[]{
				 "##S____#_#",
				  "_#_#_#_#__",
				  "#_##______",
	...
	/**
	 * This method checks the correctness of MazeSolver class
	 * when there is the long path from start to end
	 */
	@Test
	 public void testMazeSolution15x10() {
	 ...
	 */
	@Test
    public void testMazeSolver30x10() {
